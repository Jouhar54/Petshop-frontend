  ...
  return (
    <>
      <header className="bg-white ">
        <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 shadow-md lg:px-8 " aria-label="Global">
          <div className="flex lg:flex-1">
            <Link to='/' className="flex -m-1.5 p-1.5">
              <span className="sr-only">Pet Shop</span>
              <img className="h-8 w-auto" src="src/assets/logo/logo.png" alt="" />
              <h1 className='text-lg font-semibold leading-6 text-gray-600 mt-1 ml-1'>Pet Food Co.</h1>
            </Link>
          </div>
          ...
          <div className=" hidden lg:flex lg:flex-1 lg:justify-center " >
            <button className="relative py-2" onClick={handleShowCart}>
              <div className="t-0 absolute left-3">
                <p className="flex h-2 w-2 items-center justify-center rounded-full bg-red-500 p-3 text-xs text-white">{items ? items.length : 0}</p>
              </div>
